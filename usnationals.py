...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route(
        ...
        handler=get_group_info.GetHeatInfo),
    ...
    webapp2.Route(r'/current_group/<stage_id:.>', handler=current_group.CurrentHeat),
    ...
    webapp2.Route('/admin/assign_later_groups', handler=assign_groups.AssignHeats, name='assign_groups'),
